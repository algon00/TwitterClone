        ...
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item my-icon"><a class="nav-link"><img src="<?php echo HOME_URL; ?>img/img_uploaded/user/sample-person.jpg" alt=""></a></li>
                </ul>
            </div>
        </div>
        <div class="main">
                ...
                　　　　 <div class="tweet">
                            ...
                            <div class="content">
                                ...
                                <div class="icon-list">
                                    ...
                                    <div class="like-count"><?php echo htmlspecialchars($view_tweets['like_count']);?></div>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
