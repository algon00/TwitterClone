        ...
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item my-icon"><a class="nav-link"><img src="./img/img_uploaded/user/sample-person.jpg" alt=""></a></li>
                </ul>
            </div>
        </div>
        <div class="main">
            ...
            <div class="tweet-list">
                ...
                <div class="tweet">
                    ...
                    <div class="content">
                        ...
                        <img src="./img/img_uploaded/tweet/sample-post.jpg" alt="" class="image-post">
                        <div class="icon-list">
                            <div class="like">
