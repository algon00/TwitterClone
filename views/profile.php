...
<head>
    ...
    <title>プロフィール画面 / titterクローン</title>
        ...
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a href="post.php" class="nav-link"><img src="./img/icon-post-tweet-twitterblue.svg" alt="" class="post-icon"></a></li>
                    <li class="nav-item my-icon"><a class="nav-link"><img src="./img/img_uploaded/user/sample-person.jpg" alt="" class="js-popover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-html="true" data-bs-content="<a href='profile.php'>プロフィール</a><br><a href='sign-out.php'>ログアウト</a>"></a></li>
                </ul>
            </div>
        </div>
        <div class="main">
            ...
            <div class="profile-area">
                <div class="top">
                    <div class="user"><img src="./img/img_uploaded/user/sample-person.jpg" alt=""></div>
                    <?php if($_GET['user_id']) : ?>
                        <!--相手のページ-->
                        <?php if($_GET['case']) : ?>
                            ...
                            <div class="modal-content">
                                <form action="profile.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        <div class="user">
                                            <img src="./img/img_uploaded/user/sample-person.jpg" alt="">
                                        </div>
                                        <div class="mb-3">
